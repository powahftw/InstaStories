...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", metavar="<number of persons>", type=int, help="Insert the number of people to scrape (default is all the people)", default=0)
    ...
    parser.add_argument("-d", metavar="<delay>", type=int, help="Set the delay (in seconds) between scraping sessions in \"loop\" mode")
    ...
    if args.l == "loop" and (args.d is None):
        ...
        base_delay = args.d
    cookie_path, number_of_persons, folder_path, mode_flag, loop_flag = args.t, args.n, args.f, args.m, args.l
    running = True
    while running:
        ...
        if loop_flag == "single": running = False
            ...
            if args.dp:
                ...
                variance = int(base_delay/100*15)
